    ...
    <div data-theme={theme} className='flex flex-col min-h-screen justify-center items-center bg-page-light dark:bg-page-dark p-24'>
      <div className='mb-6'>
        <div className='flex items-center cursor-pointer'>
          ...
          <span className='ml-3 text-grey-700 dark:text-gray-300 font-medium'>{theme === "light" ? "light" : "dark"}</span>
        </div>
      </div>
      <div className='mx-auto flex flex-col gap-3 '>
        <h1 className='text-4xl font-bold text-center text-gray-800 dark:text-white mb-8'><span className='bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-500'>My todo App</span></h1>
        <AddTodo onAdd={onAdd}/>
